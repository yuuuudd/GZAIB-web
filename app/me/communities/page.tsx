...
export default async function ManagedCommunitiesPage() {
  ...
  return <main className="member-center-shell">
    <header className="brand-header member-page-header"><Link className="brand-mark" href="/" aria-label="广州AI共创社首页"><Image src="/logo.png" alt="广州AI共创社" width={44} height={44} /><span>广州AI共创社</span></Link><nav className="brand-nav" aria-label="主导航"><Link href="/communities">AI 社群</Link><Link className="brand-nav-active" href="/me/communities">我的社群</Link></nav><Link className="brand-header-action" href="/communities/submit">提交新社群</Link></header>
