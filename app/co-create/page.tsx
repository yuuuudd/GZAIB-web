...
export default async function CoCreatePage() {
  ...
  const items = projects.map((project) => ({ ...project, deadline: project.deadline ?? undefined, location: project.location ?? undefined, startsAt: project.startsAt ?? undefined, endsAt: project.endsAt ?? undefined, isOwner: project.ownerUserId === userId }));
